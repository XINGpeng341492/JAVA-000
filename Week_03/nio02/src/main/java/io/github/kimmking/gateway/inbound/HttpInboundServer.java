...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, String proxyServer, List<String> proxyServerList) {
        this.port=port;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .handler(new LoggingHandler(LogLevel.INFO)).childHandler(new HttpInboundInitializer(this.proxyServer,this.proxyServerList));
